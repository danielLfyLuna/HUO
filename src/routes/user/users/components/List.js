        ...
        render: (text, record) => {
          ...
          return (
            <Row gutter={16}>
              ...
              {
                record.name !== 'admin' &&
                options.authRoutes.includes('user-role') &&
                <Col span={6}>
