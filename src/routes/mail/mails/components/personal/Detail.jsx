...
import { Form, Input, InputNumber, Tooltip, Icon, Radio, Row, Col, Cascader, Table, Button, Modal, Switch } from 'antd'
...
class DetailModal extends Component {
  ...
  constructor(props) {
    ...
    this.columns = [{
      ...
      title: '操作',
      render: (text, record) => {
        return <Button onClick={() => this.handleUpdateReceiver(record)}>修改收件人</Button>
      }
    }]
  }
