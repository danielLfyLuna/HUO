...
export class LogProducesFilter extends Component {
  ...
  render() {
    ...
    for (let key in this.props.produce.produceSources) {
      produceSources.push({value: this.props.produce.produceSources[key], label: `${key}(${this.props.produce.produceSources[key]})`})
    }
